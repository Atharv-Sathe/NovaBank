...
function SubHero() {
    return (
        <div className="bg-bgColSec w-[37%] rounded-3xl h-[48vh] border-2 text-primary mt-10 relative flex flex-col justify-end ml-8 md:w-full md:ml-0">
            <Heading />
            ...
            <div className="flex flex-row gap-4 ml-8 justify-between items-center">
                <p className="font-light w-52 flex-grow pt-4"> Monitor all your purchases in
                    one place and freeze or
                    unfreeze your card in a few
                    tops
                </p>
                <img src={fingerBoy} alt="Boy raising fingers"  className="rounded-3xl mr-10 flex-shrink w-56 h-60"/>
            </div>
        </div>
    )
}
